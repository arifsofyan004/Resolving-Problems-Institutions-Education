...
def predict_status_proba(model, preprocessor, data):
...
def main():
    ...
    if st.sidebar.button("Prediksi"):
        prediction_proba = predict_status_proba(model, preprocessor, input_data)
        ...
        if dropout_prob > 0.5:
            ...
            st.write("Kemungkinan besar siswa tidak drop out.")
