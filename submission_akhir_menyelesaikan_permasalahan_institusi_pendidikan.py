...
"""Berdasarkan hasil evaluasi, model Random Forest adalah pilihan terbaik. Model ini menunjukkan akurasi tertinggi sebesar 84% dibandingkan dengan Logistic Regression (79%) dan Gradient Boosting (83.6%). Selain itu, Random Forest memiliki F1-score yang lebih tinggi untuk kelas 1, menunjukkan keseimbangan yang baik antara presisi dan recall.

Oleh karena itu, Random Forest adalah pilihan terbaik di antara ketiga model yang diuji. Selanjutnya, akan dilakukan tuning parameter lebih lanjut untuk meningkatkan kinerja model Random Forest.
"""
...
param_space_rf = {
    ...
    'classifier__min_samples_split': [2, 20, 30],
    'classifier__min_samples_leaf': [1, 5, 10],
    'classifier__bootstrap': [True, False]
}

model_rf = GridSearchCV(rf_model, param_grid=param_space_rf, cv=3, scoring='accuracy')
...
print("Model Best Score (Random Forest):", model_rf.best_score_)
print("Test Accuracy:", model_rf.score(X_test_processed, y_test))
